...
void rectangle(int l, int c, char car)
{
    for (int i = 1; i < l; i++)
    {
        ligne(l, car);
...
void rectangleCouleur(int l, int c, char caractere)
{
    for (int i = 0; i <= l; i++)
    {
        int couleur = rand() % 15 + 1;
        setColor(couleur);
        ligne(c, caractere);
        printf("\n");
    }
...
void triangleRectangle(int longueur, int colonne, char caractere)
{
    for (int i = 0; i <= colonne; i++)
    {
        int couleur = rand() % 15 + 1;
        setColor(couleur);
        ligne(longueur, caractere);
        printf("\n");
        longueur--;
    }
}
